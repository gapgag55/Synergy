              ...
              <View style={styles.rect4}>
                <View style={styles.fbIconRow}>
                  <MaterialCommunityIconsIcon
                    ...
                    style={styles.fbIcon}
                  />
                  <Text style={styles.fbSignupText}>Sign Up with Facebook</Text>
                </View>
              </View>
            </View>
            <View style={styles.ggSignup}>
              <View style={styles.rect7}>
                <View style={styles.ggIconRow}>
                  <MaterialCommunityIconsIcon
                    ...
                    style={styles.ggIcon}
                  />
                  <Text style={styles.ggSignupText}>Sign Up with Google</Text>
                </View>
              </View>
            </View>
          </View>
