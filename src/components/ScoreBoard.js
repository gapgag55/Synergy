    ...
    return (
      <View style={{ flex: 1, justifyContent: "center", alignItems: "center" }}>
        ...
        <View style={styles.container}>
          <Image source={require('../../img/best.png')} style={styles.image} />   
        ...
        <View style={styles.container}>
          <Image source={require('../../img/second.png')} style={styles.image} />   
            <View style={styles.postDetailsContainer}>
        ...
        <View style={styles.container}>
          <Image source={require('../../img/third.png')} style={styles.image} />   
            <View style={styles.postDetailsContainer}>
